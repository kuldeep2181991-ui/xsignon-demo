...
urlpatterns = [
    ...
    path('postureone/', views.posture_one, name="postureone"),
    ...
    path('xsignon-insights/news-details1.html', views.news_details1, name="news-details1"),
    path('xsignon-insights/news-details2.html', views.news_details2, name="news-details2"),
