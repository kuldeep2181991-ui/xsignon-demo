...
urlpatterns = [
    ...
    path('enterprise-technology-solutions/', views.enterprise_performance, name="enterprise-technology-solutions"),
    ...
    path('xsignon-insights/news-details1.html', views.news_details, name="news-details1"),
    path('xsignon-insights/news-details2.html', views.news_details, name="news-details2"),
    path('xsignon-insights/news-details3.html', views.news_details, name="news-details3"),
    path('xsignon-insights/news-details4.html', views.news_details, name="news-details4"),
